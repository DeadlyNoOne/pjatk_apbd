...
namespace Tests
{
    public class UnitTest1
    {
        ...
        public void Task5_Test()
        {
            ...
            Assert.True(firstEmp.ToString().Equals(new { Nazwisko = "Tina Vaakkutarii", Praca = "Frontend programmer" }.ToString()));
        ...
        public void Task6_Test()
        {
            ...
            Assert.NotNull(studRes);
            Assert.True(studRes.Last().ToString().Equals(new { Ename = "Edith Gavanrakh", Job = "KING", Dname = "Accounting" }.ToString()));
        }
        ...
        public void Task9_Test()
        {
            ...
            Assert.NotNull(studRes);
            Assert.Equal("Tina Vaakkutarii", studRes.Ename);
        ...
        public void Task10_Test()
        {
            ...
            Assert.True(studRes.ElementAt(11).ToString().Equals(new { Ename = "Edith Gavanrakh", Job = "KING", HireDate = kingHiredate }.ToString()));
            Assert.True(studRes.Last().ToString().Equals(new { Ename = "No value", Job = string.Empty, HireDate = (DateTime?)null }.ToString()));
